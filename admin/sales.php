...
<tr>
<th class="bg-secondary text-dark">Sales ID</th>
<th class="bg-secondary text-dark">Order ID</th>
<th class="bg-secondary text-dark">Order Total</th>
...
while($row = $result->fetch_assoc()) {
    echo "<tr><td>" . $row["sales_id"]. "</td><td>" . $row["order_id"]. "</td><td>" . $row["order_cost"] . "</td><td>" . $row["order_quantity"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["date"]. "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
